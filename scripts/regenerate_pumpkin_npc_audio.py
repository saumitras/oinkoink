"""Regenerate Pumpkin Farm's curated NPC openers with character voice direction."""
...
TEMPLATE_ID = "76VwFrCWC21dOuUiBJWhA"
...
async def main() -> None:
    ...
    if not game.bible:
        raise RuntimeError("Pumpkin Farm template has no game bible")
